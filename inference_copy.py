...
def infer(flowtron_path, waveglow_path, output_dir, text_list, speaker_id, n_frames,
    ...
    for i, text_entry in enumerate(text_list):
        trainset = Data(
            data_config['training_files'],
            **dict((k, v) for k, v in data_config.items() if k not in ignore_keys))
        speaker_vecs = trainset.get_speaker_id(speaker_id).cuda()
        text = trainset.get_text(text_entry).cuda()
        ...
        for k in range(len(attentions)):
            ...
            fig.savefig(os.path.join(output_dir, 'sid{}_sigma{}_attnlayer{}_{}.png'.format(speaker_id, sigma, k, i)))
            plt.close("all")
        ...
        write(os.path.join(output_dir, 'sid{}_sigma{}_{}.wav'.format(speaker_id, sigma, i)),
...
if __name__ == "__main__":
    ...
    harvard_sentences = [
        ...
        "These days a chicken leg is a rare dish.",  #3
        "Rice is often served in round bowls.",
        "The juice of lemons makes fine punch.",  #5
        ...
        "The soft cushion broke the man's fall.",  #17
        "The salt breeze came across from the sea.",
        "The girl at the booth sold fifty bonds.",
        "The small pup gnawed a hole in the sock.",  #20
        "The fish twisted and turned on the bent hook.",  #21
        "Press the pants and sew a button on the vest.",
        "The swan dive was far short of perfect.",
        "The beauty of the view stunned the young boy.",
        "Two blue fish swam in the tank.",  #25
        "Her purse was full of useless trash.",
        "The colt reared and threw the tall rider.",
        "It snowed, rained, and hailed the same morning.",
        "Read verse out loud for pleasure.",
    ]
    infer(args.flowtron_path, args.waveglow_path, args.output_dir, harvard_sentences,
